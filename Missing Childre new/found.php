...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO found_children (child_name, gender, disability_type, age, cnic, contact, last_seen) 
...
<head>
    ...
    <title>Found Children Information</title>
...
<body>
    <div class="container1" style="margin-bottom: 400px; margin-top: 400px;">
        ...
        <div class="wrapper" style="height: 880px; width: 500px; background-color: lightslategrey" >
            <h1  style="border-bottom: 8px solid black; width: 450px; margin-bottom: 50px; font-size: 36px;">Found Child Information</h1>
